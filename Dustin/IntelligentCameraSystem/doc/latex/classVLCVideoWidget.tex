...
\begin{DoxyCompactList}\small\item\em Reset the values of the statistics captured from the V\-L\-C client for the current video. \end{DoxyCompactList}\end{DoxyCompactItemize}
...
\begin{DoxyCode}
140 \{
141     \textcolor{keywordflow}{if}(e->key() == Qt::Key\_Down)
142     \{
143         this->\hyperlink{classVLCVideoWidget_aefa842a30cbb11522428597c1f0608a0}{stopPlaying}();
144     \}
145 \}
\end{DoxyCode}
...
\begin{DoxyCode}
120 \{
121     QStyleOption opt;
122     opt.init(\textcolor{keyword}{this});
123     QPainter p(\textcolor{keyword}{this});
124     style()->drawPrimitive(QStyle::PE\_Widget, &opt, &p, \textcolor{keyword}{this});
125 \}
\end{DoxyCode}
