...
216 \{
217     this->show();
218     QGraphicsOpacityEffect *fade\_in\_effect = \textcolor{keyword}{new} QGraphicsOpacityEffect(\textcolor{keyword}{this});
219     this->setGraphicsEffect(fade\_in\_effect);
220     QPropertyAnimation *fade\_in\_animation = \textcolor{keyword}{new} QPropertyAnimation(fade\_in\_effect, \textcolor{stringliteral}{"opacity"});
221     fade\_in\_animation->setEasingCurve(QEasingCurve::InOutQuad);
222     fade\_in\_animation->setDuration(250);
223     fade\_in\_animation->setStartValue(0.1);
224     fade\_in\_animation->setEndValue(0.8);
225 
226     fade\_in\_animation->start(QPropertyAnimation::DeleteWhenStopped);
227 
228 \}
\end{DoxyCode}
...
\begin{DoxyCode}
199 \{
200     QGraphicsOpacityEffect *fade\_out\_effect = \textcolor{keyword}{new} QGraphicsOpacityEffect(\textcolor{keyword}{this});
201     this->setGraphicsEffect(fade\_out\_effect);
202     QPropertyAnimation *fade\_out\_animation = \textcolor{keyword}{new} QPropertyAnimation(fade\_out\_effect, \textcolor{stringliteral}{"opacity"});
203     fade\_out\_animation->setEasingCurve(QEasingCurve::InOutQuad);
204     fade\_out\_animation->setDuration(175);
205     fade\_out\_animation->setStartValue(0.8);
206     fade\_out\_animation->setEndValue(0.0);
207 
208     fade\_out\_animation->start(QPropertyAnimation::DeleteWhenStopped);
209     \textcolor{comment}{//this->hide();}
210     QTimer::singleShot(225, \textcolor{keyword}{this}, SLOT(hideDelay()));
211 
212 \}
\end{DoxyCode}
