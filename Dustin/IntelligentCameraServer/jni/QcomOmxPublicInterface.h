...
#define BUILD_FOR_HONEYCOMB_AND_UP 01
...
typedef enum {
	...
	//DWRIGHT ENUM ADDITIONS
	kQcomOmxInterfaceErrorCouldNotGetAVCParams,
	kQcomOmxInterfaceErrorCouldNotSetAVCParams,
	kQcomOmxInterfaceErrorCouldNotGetFMOParams,
	kQcomOmxInterfaceErrorCouldNotSetFMOParams
...
//BEGIN DWRIGHT FUNCTIONS
int omx_interface_set_region_of_interest(void *obj, int port);

//Update the encoder bitrate
int omx_interface_update_bitrate(void *obj, int rate);

//Print the AVC parameters
int omx_interface_print_avc_params(void *obj);
